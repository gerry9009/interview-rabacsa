...
const DeleteModal = () => {
  ...
  const modalWindowStyle =
    "fixed left-0 top-0 z-10 h-full w-full outline-none bg-gray-900 bg-opacity-90 flex flex-col justify-center items-center";
    ...
    <div className={modalWindowStyle}>
      ...
      <div className="flex w-4/12 items-center justify-around ">
        <button
          ...
          className="w-28 h-10 text-2xl  hover:bg-red-500 bg-red-700 text-white font-semibold border hover:border-red-500 border-red-700 rounded"
        >
          Yes
        </button>
        <button
          onClick={closeModal}
          className="w-28 h-10 text-2xl  hover:bg-green-500 bg-green-700 text-white font-semibold border hover:border-green-500 border-green-700 rounded"
        >
          No
        </button>
      </div>
